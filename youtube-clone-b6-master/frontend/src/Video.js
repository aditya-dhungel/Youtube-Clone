    ...
    <>
      ...
      <div className='video-details'>
        <div className='channel-info'>
          <img src={gotham} height={'30px'} width={'30px'}/>
          <div className='channel-name'>
            <h6 className='margin-0'>GothamChess</h6>
            <p className='margin-0 subscribers'>4.35M subscribers</p>
          </div>
      ...
      <div className='video-desc'>
          <p>{video.views} views &nbsp; 4 days ago</p>
          <p>
